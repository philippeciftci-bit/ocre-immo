...
function ensureCountriesSchema() {
    ...
    if ((int)($r['c'] ?? 0) === 0) {
        $seed = [
            ...
            ['FR','France','🇫🇷','EUR','EUR','33',1,20],
            ['ES','Espagne','🇪🇸','EUR','EUR','34',0,30],
            ['IT','Italie','🇮🇹','EUR','EUR','39',0,40],
            ['PT','Portugal','🇵🇹','EUR','EUR','351',0,50],
            ['DE','Allemagne','🇩🇪','EUR','EUR','49',0,60],
            ['BE','Belgique','🇧🇪','EUR','EUR','32',0,70],
            ['CH','Suisse','🇨🇭','CHF','CHF','41',0,80],
            ['LU','Luxembourg','🇱🇺','EUR','EUR','352',0,90],
