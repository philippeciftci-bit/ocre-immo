...
try {
    ...
    $html = '<html><body style="font-family:-apple-system,BlinkMacSystemFont,sans-serif;color:#3a2e22;background:#FAF6EC;">'
        ...
        // M/2026/05/14/74 — bouton via ocre_btn_html() unique (mailer.php M/14/63 canonical).
        . (function_exists('ocre_btn_html') ? ocre_btn_html($url, 'Réinitialiser mon mot de passe') : '<p>Lien : ' . htmlspecialchars($url) . '</p>')
