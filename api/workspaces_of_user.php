<?php
// M/2026/05/05/6 — M-Partage-Menu : liste WSC dont l agent courant est membre.
// Stub minimal : si tables workspaces/workspace_members existent, query reelle ; sinon array vide.
...
try {
  ...
  $out = array_map(function($r){
    ...
    return ['id'=>(int)$r['id'], 'name'=>$r['name'], 'members'=>$names, 'member_count'=>(int)$r['member_count']];
  }, $rows);
